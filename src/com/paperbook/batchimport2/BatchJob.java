...
public class BatchJob {
	...
	public static void main(String[] args) throws IOException {
		...
		literatureGenerator.createLiteratures(1000000);
		...
		// Insert literatures to CSV file
		start = System.currentTimeMillis();
		literatureGenerator.createCSVFile();
		System.out.println("Create CSV file done with time " + (System.currentTimeMillis() - start));
...
//		commentsTable.close();
		...
		System.out.println("All jobs done , running time: " + (end - start));
	}
